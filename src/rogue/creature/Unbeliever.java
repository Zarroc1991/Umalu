...
/**
 * Der Ungläubige ist ein mittelstarkes Monster (Kat 5/7).
		...
		// Print Result
	           Random generator = new Random();
	            ...
	            switch(ran){
	            	...
	            	case 1:Screen.showEventLineAndPutToConsole("'Kremsgrdr mag dich nicht mehr.'"+dam, true, true);break;//optional hier alles sichtbare lï¿½schen
